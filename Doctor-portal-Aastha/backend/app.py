...
# DOCTOR BY USER
# -------------------------
@app.route("/api/doctor/by-user/<user_id>")
...
# -------------------------
# NEW: REPORTS BY DOCTOR (SAFE ADDITION)
# -------------------------
...
# -------------------------
# EXISTING REPORTS BY PATIENT (UNCHANGED)
# -------------------------
...
# -------------------------
@app.route("/api/medicines/search/<query>")
